...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐁𝐋𝐀𝐂𝐊 𝐀𝐋𝐏𝐇𝐀 𝐖𝐀 𝐁𝐎𝐓 𝐒𝐋',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐒𝐋;𝐒𝐀𝐂𝐇𝐈𝐓𝐇;972528277755;https://i.imgur.com/NGaJQta.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐒𝐋;𝐒𝐀𝐂𝐇𝐈𝐓𝐇;https://i.imgur.com/NGaJQta.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐒𝐋;𝐒𝐀𝐂𝐇𝐈𝐓𝐇' : process.env.STICKER_DATA,
